...
%global pname sahara-plugin-mapr
%global module sahara_plugin_mapr
...
%global common_desc \
The MapR plugin for Sahara allows Sahara to provision and \
...
Summary:          MapR plugin for Sahara
...
Summary:        Tests of the MapR plugin for Sahara
...
This package contains the test files of the MapR plugin for Sahara.
...
Group:         Documentation
Summary:       Usage documentation for the MapR plugin for Sahara
Requires:      python%{pyver}-%{pname} = %{version}-%{release}
...
This documentation provides details about the MapR plugin for Sahara.
...
# REMOVEME: error caused by commit http://git.openstack.org/cgit/openstack/sahara-plugin-mapr/commit/?id=ee926298eaf6b66d8a9ada545a6ed3360e5faa1d
